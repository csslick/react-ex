    ...
    <>
      <footer className="container" id="main_footer">
        <ul className="sns">
          ...
          <li><a href="https://github.com/csslick"><i class="fa fa-github-square" aria-hidden="true"></i></a></li>
          <li><a href="mailto:tailofmoon@naver.com"><i class="fa fa-envelope" aria-hidden="true"></i></a></li>
          <li><a href="tel:010-6340-2948"><i class="fa fa-phone-square" aria-hidden="true"></i></a></li>
        </ul>
