    ...
    <section className='container' id="bookInfo">
      <div className="row">
        ...
        <article 
          ...
          <p>웹 퍼블리셔, 프론트엔드 웹 개발자를 위한 웹 프로그래밍 레시피! 프로그래밍 언어를 공부할 때는 실무에서 많이 사용하는 코드를 조금씩 구현해보면서 익히는 것이 좋다. 이 책에서는 실무와 밀접한 내용을 다양한 유형의 웹 애플리케이션이나 UI 요소로 익힐 수 있도록 9가지 프로젝트를 구성했다</p>
